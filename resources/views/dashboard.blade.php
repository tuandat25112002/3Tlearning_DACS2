        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('danhmuc.index')}}">Danh sách môn học</a></li>
                        <li><a href="{{route('danhmuc.create')}}">Thêm môn học</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{route('giaovien.create')}}">Thêm giáo viên</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('sanpham.index')}}">Danh sách khóa học</a></li>
                        <li><a href="{{route('sanpham.create')}}">Thêm khóa học</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('baihoc.index')}}">Danh sách bài học</a></li>
                        <li><a href="{{route('baihoc.create')}}">Thêm bài học</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('tailieu.index')}}">Danh sách tài liệu</a></li>
                        <li><a href="{{route('tailieu.create')}}">Thêm tài liệu</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('baihoc.index')}}">Bài viết</a></li>
                        <li><a href="{{route('baihoc.create')}}">Thêm bài viết</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('baihoc.index')}}">Danh sách tin tức</a></li>
                        <li><a href="{{route('baihoc.create')}}">Đăng tin tức</a></li>
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{route('lophoc.create')}}">Thêm lớp</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('sinhvien.index')}}">Sinh viên</a></li>
