                ...
                @endif
                    ...
                    @endif
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="POST" action="{{route('sinhvien.store')}}" novalidate="novalidate">

                                     @csrf
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Mã sinh viên: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="firstname" name="MaSV" type="text">
                                        </div>
                                    </div>
                                      <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Họ và Tên: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="firstname" name="hoten" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">Ngày sinh: </label>
                                        <div class="col-lg-6">
                                        <input type="date" class="form-control" name="ngaysinh" value="{{old('ngaysinh')}}" min="1993-01-01" max="2007-12-31"  ></div>
                                    </div>
                                     <div class="form-group ">
                                     ...
                                     <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                             <input type="number" step="0.05" min="0" max="10" class="form-control" name="tongdiem" value="{{old('tongdiem')}}"  >
                                        </div>
                                    </div>
                                    <div class="form-group">
